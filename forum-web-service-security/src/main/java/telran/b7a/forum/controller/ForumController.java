...
public class ForumController {
	...
	public Iterable<PostDto> getPostsByTags(@PathVariable Set<String> tags) {
		return service.findPostsByTags(tags);
	}
	
	@GetMapping("/posts/period")
	public Iterable<PostDto> getPostsByPeriod(@PathVariable LocalDate fromDate, @PathVariable LocalDate toDate) {
		return service.findPostsByPeriod(fromDate, toDate);
	}
